...
<body>
    ...
    <div class="admin-panel">
        ...
        <div class="content1">
            ...
            <h1>Here is Doctor's Details...!</h1><br><br><br>

    <?php


    // Fetch data from the database
    $sql = "SELECT doctor_name, email, category, password FROM doctor";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Doctor_name</th><th>Email</th><th>Category</th><th>Password</th><th>Actions</th></tr>";
